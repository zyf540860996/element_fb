...
export default {
  ...
  methods: {
    goCodepen() {
      ...
      const resourcesTpl = '<scr' + 'ipt src="//unpkg.com/vue/dist/vue.js"></scr' + 'ipt>' + '\n<scr' + `ipt src="//unpkg.com/nasinet-element-ui_fb@${version}/lib/index.js"></scr` + 'ipt>';
      let jsTpl = (script || '').replace(/export default/, 'var Main =').trim();
      let htmlTpl = `${resourcesTpl}\n<div id="app">\n${html.trim()}\n</div>`;
      let cssTpl = `@import url("//unpkg.com/nasinet-element-ui_fb@${version}/lib/theme-chalk/index.css");\n${(style || '').trim()}\n`;
