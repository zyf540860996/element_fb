...
```html
/* theme color */ $--color-primary: teal; /* icon font path, required */ $--font-path: '~nasinet-element-ui_fb/lib/theme-chalk/fonts'; @import "~nasinet-element-ui_fb/packages/theme-chalk/src/index";
```
