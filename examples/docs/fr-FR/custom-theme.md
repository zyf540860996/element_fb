...
```html
/* couleur du thème */ $--color-primary: teal; /* chemin vers le fichier de police, requis */ $--font-path: '~nasinet-element-ui_fb/lib/theme-chalk/fonts'; @import
"~nasinet-element-ui_fb/packages/theme-chalk/src/index";
```
