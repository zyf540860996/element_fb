...
import ElRadio from 'nasinet-element-ui_fb/packages/radio';
import { isEqual } from 'nasinet-element-ui_fb/src/utils/util';
...
export default {
  ...
  methods: {
    ...
    renderCheckbox(h) {
      ...
      return <el-checkbox value={node.checked} indeterminate={node.indeterminate} disabled={isDisabled} {...events} />;
    },
