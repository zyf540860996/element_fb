  ...
  <transition name="el-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div v-show="visible" class="el-time-range-picker el-picker-panel el-popper" :class="popperClass">
      ...
      <div class="el-time-panel__footer">
        ...
        <button type="button" class="el-time-panel__btn confirm" @click="handleConfirm()" :disabled="btnDisabled">{{ t('el.datepicker.confirm') }}</button>
      </div>
    </div>
  </transition>
</template>
...
import { parseDate, limitTimeRange, modifyDate, clearMilliseconds, timeWithinRange } from 'nasinet-element-ui_fb/src/utils/date-util';
