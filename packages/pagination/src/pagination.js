...
import ElSelect from 'nasinet-element-ui_fb/packages/select';
import ElOption from 'nasinet-element-ui_fb/packages/option';
import ElInput from 'nasinet-element-ui_fb/packages/input';
import Locale from 'nasinet-element-ui_fb/src/mixins/locale';
import { valueEquals } from 'nasinet-element-ui_fb/src/utils/util';
...
export default {
  ...
  render(h) {
    ...
    const TEMPLATE_MAP = {
      prev: <prev />,
      jumper: <jumper />,
      pager: <pager currentPage={this.internalCurrentPage} pageCount={this.internalPageCount} pagerCount={this.pagerCount} on-change={this.handleCurrentChange} disabled={this.disabled} />,
      next: <next />,
      ...
      render(h) {
        return (
          <span class="el-pagination__sizes">
            <el-select value={this.$parent.internalPageSize} popperClass={this.$parent.popperClass || ''} size="mini" on-input={this.handleChange} disabled={this.$parent.disabled}>
