  ...
  >
    <div class="el-tree-node__content" :style="{ 'padding-left': (node.level - 1) * tree.indent + 'px' }">
      <span
        ...
        :class="[{ 'is-leaf': node.isLeaf, expanded: !node.isLeaf && expanded }, 'el-tree-node__expand-icon', tree.iconClass ? tree.iconClass : 'el-icon-caret-right']"
      >
      </span>
...
import ElCollapseTransition from 'nasinet-element-ui_fb/src/transitions/collapse-transition';
